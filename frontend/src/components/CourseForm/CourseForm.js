...
export default function HomeDashboard() {
  ...
  async function formSubmit(e) {
    ...
    const courseData = {
      ...
      difficulty: values.difficulty || userDifficulty,  // Use the fallback userDifficulty if no selection is made
      targetLang: values.language || userLanguage,     // Use the fallback userLanguage if no selection is made
          ...
          {showCourse && (
            <div style={{ width: "600px" }}>
              <form method="post" onSubmit={formSubmit}>
                ...
                <div>
                  <p>Description:</p>
                  <input name="courseDesc" required />
                </div>
                <div>
                  <p>Difficulty:</p>
                  <select name="difficulty" style={{ width: "100%", padding: "8px", fontSize: "16px" }} required>
                ...
                <div>
                  <p>Learn:</p>
                  <select name="language" style={{ width: "100%", padding: "8px", fontSize: "16px" }} required>
                ...
                <div>
                  <p>Speakers Of:</p>
                  <select name="nativeLanguage" style={{ width: "100%", padding: "8px", fontSize: "16px" }} required>
                    <option value="English">English</option>
                    <option value="Spanish">Spanish</option>
                    <option value="French">French</option>
                    <option value="Italian">Italian</option>
